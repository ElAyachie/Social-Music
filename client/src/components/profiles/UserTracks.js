...
function UserTracks() {
    ...
    return (
        <div className="track">
            <img className="picture" src="https://api.deezer.com/album/69319552/image" height="55px" width="55px"></img>
            <h2 className="title">Drake - In My Feelings</h2>
            <img className="upvote-icon" src={Upvote_Icon}></img>
            <img className="explicit-icon" src={Explicit_Icon} height="20px" width="40px"></img>
        </div>
